    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(requests -> requests
                        ...
                        .authenticated())
                .authorizeHttpRequests(request -> request
                        .requestMatchers("/api/users/readUser/**").hasAuthority("USER") // or ADMIN
                        .requestMatchers("/api/users/readUsers/**").hasAuthority("ADMIN")
                        .requestMatchers("/api/users/updateUser/**").hasAuthority("USER") // or ADMIN
                        .requestMatchers("/api/users/deleteUser/**").hasAuthority("ADMIN")
